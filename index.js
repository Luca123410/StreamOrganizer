    ...
    contentSecurityPolicy: {
      directives: {
        ...
        "connect-src": [
          ...
          process.env.VERCEL_URL // URL Vercel
        ],
...
app.use(express.static('public')); // Serve i file da 'public'
...
// Schema corretto: non si aspetta più 'authKey' nel body
...
// Forza HTTPS (opzionale su Vercel, ma buono da avere)
app.use((req, res, next) => {
  if (process.env.VERCEL_ENV && req.header('x-forwarded-proto') !== 'https') {
